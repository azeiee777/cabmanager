    ...
    <div class="pt-2">
        ...
        <form id="apiExpenseForm" class="space-y-5">
            ...
            <div class="flex flex-col space-y-1.5">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500"><i
                            data-lucide="fuel" class="w-4 h-4"></i></div>
                    <select name="type"
                        class="w-full bg-gray-900 border border-gray-700 text-gray-200 rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:border-amber-500 appearance-none">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="description" placeholder="Detail the expense..."
                    class="w-full bg-gray-900 border border-gray-700 text-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 h-24 custom-scrollbar"></textarea>
            </div>

            <div class="pt-6">
                <button type="submit" id="saveExpBtn"
                    class="w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-4 rounded-xl shadow-[0_0_20px_rgba(244,63,94,0.3)] transition-all active:scale-[0.98]">
                    Record Expense
                </button>
            </div>
        </form>
